...
//                    百分之25之前是红色  百分之25之后到百分之75之前是黄色  百分之75之后到百分之100之前是黄色
                            color: [[0.25, '#50edb3'], [0.89, '#ea8cdb'], [1, '#393a5a']]
                        }
                    },
                    axisTick: {            // 坐标轴小标记
            ...
            xAxis: [
                {
                    type: 'category',
                    boundaryGap: false,
                    data: ['8 Jun', '6:00', '12:00', '18:00', '9 Jun', '6:00', '12:00', '18:00', '10 Jun'],
                    axisTick: {
                        show: false,
                    },
                    axisLabel: {
            ...
            series: [
                {
                    ...
                    data: [0, 400, 600, 1000, 800, 400, 1000, 900, 500]
                }
            ]
        }
